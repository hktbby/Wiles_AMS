...
<h2 class="text-center mb-2">User Table tenant</h2>
    ...
    <table class="table table-bordered">
      ...
      foreach ($data as $rows) {
        ...
        <?php endif; ?>
          ...
          <td><?php echo $rows['payment']; ?></td><!--birthday ginawang payment-->
          <td><?php echo $rows['sex']; ?></td>
          <td><?php echo $rows['Username']; ?></td>
          <td><?php echo $rows['tenant_add_floor']; ?></td>
          <td><?php echo $rows['tenant_add_unitNo']; ?></td>
          <td><?php echo $rows['tenant_add_numBed']; ?></td>
          <td><?php echo $rows['tenant_Amount']; ?></td>
          <td>

          <div class="btn-group" role="group">
          <form action="update.php" method="post" class="d-inline">
                                    <input type="hidden" name="id" value="<?php echo $rows['tenantID']; ?>">
                                ...
                                <form method="POST" class="d-inline">
                                    <input type="hidden" name="id" value="<?php echo $rows['tenantID']; ?>">
                                    <button type="submit" name="delete" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this tenant?')">
        ...
        <div class="card-container">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="card-text"><strong>Floor #:</strong> <?php echo ucwords(htmlspecialchars($rows['tenant_add_floor'])); ?></p>
                    <p class="card-text"><strong>Unit #:</strong> <?php echo ucwords(htmlspecialchars($rows['tenant_add_unitNo'])); ?></p>
                    <p class="card-text"><strong>Bed/s:</strong> <?php echo ucwords(htmlspecialchars($rows['tenant_add_numBed'])); ?></p>
                    <p class="card-text"><strong>Total Amount:</strong> <?php echo ucwords(htmlspecialchars($rows['tenant_Amount'])); ?></p>
                    <form action="update.php" method="post" class="d-inline">
                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($rows['tenantID']); ?>">
                        <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                    </form>
                    <form method="POST" class="d-inline">
                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($rows['tenantID']); ?>">
                        <input type="submit" name="delete" class="btn btn-danger btn-sm" value="Delete" onclick="return confirm('Are you sure you want to delete this tenant?')">
                    </form>
                </div>
            </div>
            <?php
