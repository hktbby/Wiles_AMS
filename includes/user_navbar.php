  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item <?php echo ($current_page == 'user_account.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="user_account.php">dashboard<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item <?php echo ($current_page == 'enrolphp.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="enrol.php">other info</a>
      </li>
      <li class="nav-item <?php echo ($current_page == 'enrolled_courses.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="enrolled_courses.php">ddadadad</a>
      </li>
    </ul>
  </div>
